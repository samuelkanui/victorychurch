        ...
        <div class="space-y-6 p-6">
            ...
            <div class="grid gap-4 md:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-blue-600">{{ assignments?.data?.length || 0 }}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-green-600">
                            {{ assignments?.data?.filter(a => a.is_active).length || 0 }}
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-red-600">
                            {{ assignments?.data?.filter(a => a.is_active && isOverdue(a.due_date)).length || 0 }}
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-purple-600">
                            {{ assignments?.data?.reduce((sum, a) => sum + (a.submissions_count || 0), 0) || 0 }}
                        </div>
            ...
            <Card>
                ...
                <CardContent>
                    <div v-if="!assignments?.data || assignments.data.length === 0" class="text-center py-12">
